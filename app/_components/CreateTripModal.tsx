    ...
    isOpen && (
      <div className="fixed inset-0 bg-slate-900 bg-opacity-50 flex justify-center items-center">
        ...
        <div className="p-8 rounded-lg w-96 bg-cyan-800 border-black border-2 ">
          ...
          <h2 className="text-2xl font-bold mb-4 text-white">Create New Trip</h2>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="country" className="block text-lg mb-2 text-white">
                Country
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="start_date" className="block text-lg mb-2 text-white">
                Start Date
              </label>
              <input
                type="date"
            ...
            <div className="mb-4">
              <label htmlFor="end_date" className="block text-lg mb-2 text-white">
                End Date
              </label>
              <input
                type="date"
